...
> 官方示例：[offline-map](https://docs.mapbox.com/android/maps/examples/android-view/offline-map/)

## 示例效果

![离线地图](./images/offline-map.png)

## 功能说明

使用 `OfflineManager` 下载地图瓦片，实现离线地图。

<details>
<summary>英文原文</summary>

This example demonstrates how to download regional data to application for offline use. The code below allows functionality to prepare data for download, cancel a download, view the map, show downloaded regions, and remove downloaded regions by leveraging the OfflineManager and TileStore. The activity also handles logging messages and updating progress bars related to style pack and tile region downloads. Users can download up to 250MB of data for offline use without incurring additional charges (subject to change during the beta).
...
- [官方文档（英文）](https://docs.mapbox.com/android/maps/examples/android-view/offline-map/)
- [GitHub 源码](https://github.com/mapbox/mapbox-maps-android/blob/v11.24.3/app/src/main/java/com/mapbox/maps/testapp/examples/OfflineActivity.kt)
