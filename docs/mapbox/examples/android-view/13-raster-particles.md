# 栅格粒子图层（Display a raster particle layer）

> 官方示例：[raster-particles](https://docs.mapbox.com/android/maps/examples/android-view/raster-particles/)

## 示例效果

<video controls width="100%" src="./images/raster-particles.mp4"></video>

> 本示例为视频效果（本地文件 `./images/raster-particles.mp4`）。

## 功能说明

演示使用 `RasterParticleLayer` 与 `RasterArraySource` 在地图上展示风向与风速（官方页面为视频效果）。

<details>
<summary>英文原文</summary>

Your browser doesn't support HTML5 video. Open link to the video. This example demonstrates how to showcase wind direction and speed using Mapbox Maps SDK for Android. In the code below, a RasterParticleLayer is created and displays wind data on the map. The Mapbox Standard style with a night LightPreset with is added to the MapView using a RasterArraySource. The RasterParticleLayer is customized with speed, count, color, and other parameters using expressions and interpolation spawning particles at varying speeds and colors based on the wind intensity.
...
- [官方文档（英文）](https://docs.mapbox.com/android/maps/examples/android-view/raster-particles/)
- [GitHub 源码](https://github.com/mapbox/mapbox-maps-android/blob/v11.24.3/app/src/main/java/com/mapbox/maps/testapp/examples/style/RasterParticlesActivity.kt)
