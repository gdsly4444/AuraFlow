# 图层内点聚合（Cluster points within a layer）

> 官方示例：[cluster-points-within-a-layer](https://docs.mapbox.com/android/maps/examples/android-view/cluster-points-within-a-layer/)

## 示例效果

![图层内点聚合](./images/cluster-points-within-a-layer.png)

## 功能说明

从 GeoJSON 源创建 CircleLayer 并对点进行聚合，聚合随相机变化更新。

<details>
<summary>英文原文</summary>

This example demonstrates how to cluster points on a map when zooming out with the Mapbox Maps SDK for Android. The code below loads a map with clusters of data points represented as circles. The locations on the map are stored in a GeoJsonSource, specifying the clustering options such as cluster radius and maximum zoom level.
...
- [官方文档（英文）](https://docs.mapbox.com/android/maps/examples/android-view/cluster-points-within-a-layer/)
- [GitHub 源码](https://github.com/mapbox/mapbox-maps-android/blob/v11.24.3/app/src/main/java/com/mapbox/maps/testapp/examples/CircleLayerClusteringActivity.kt)
