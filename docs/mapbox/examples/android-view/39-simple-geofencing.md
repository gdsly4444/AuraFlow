# 基础地理围栏（Create geofence zone around user's location.）

> 官方示例：[simple-geofencing](https://docs.mapbox.com/android/maps/examples/android-view/simple-geofencing/)

## 示例效果

![基础地理围栏](./images/simple-geofencing.png)

## 功能说明

演示 Geofencing API 基础用法，在用户位置周围创建地理围栏。

<details>
<summary>英文原文</summary>

This example demonstrates the usage of the Maps SDK for Android's Geofencing API to create a geofence zone for a radius around the user's location, updating its color based on events such as entering, dwelling, or leaving the geofence zone.
...
- [官方文档（英文）](https://docs.mapbox.com/android/maps/examples/android-view/simple-geofencing/)
