# 扩展地理围栏（Extended geofencing example）

> 官方示例：[extended-geofencing](https://docs.mapbox.com/android/maps/examples/android-view/extended-geofencing/)

## 示例效果

![扩展地理围栏](./images/extended-geofencing.png)

## 功能说明

结合 Isochrone API 与通知的扩展地理围栏示例。

<details>
<summary>英文原文</summary>

This example demonstrates creating geofences using the Maps SDK for Android's Geofencing API with a custom polygon. The polygon is sourced from the Mapbox Isochrone API to get a travel-time polygon for the user's current location. The Geofencing API handles events, displaying notifications for entry, dwell, and exit.
...
- [官方文档（英文）](https://docs.mapbox.com/android/maps/examples/android-view/extended-geofencing/)
- [GitHub 源码](https://github.com/mapbox/mapbox-maps-android/blob/v11.24.3/app/src/main/java/com/mapbox/maps/testapp/examples/geofence/ExtendedGeofencingActivity.kt)
