# 运行时样式（Runtime styling）

> 官方示例：[runtime-styling](https://docs.mapbox.com/android/maps/examples/android-view/runtime-styling/)

## 示例效果

![运行时样式](./images/runtime-styling.png)
...
This example demonstrates the usage of the style extension in Mapbox Maps SDK for Android. The code below shows various ways to style a map such as adding images, symbol sources, symbol layers, fill sources, fill layers, fill extrusion layers, fill extrusion lights, image sources, and raster layers.
...
- [官方文档（英文）](https://docs.mapbox.com/android/maps/examples/android-view/runtime-styling/)
- [GitHub 源码](https://github.com/mapbox/mapbox-maps-android/blob/v11.24.3/app/src/main/java/com/mapbox/maps/testapp/examples/RuntimeStylingActivity.kt)
