# 设置地图颜色主题（Setting color theme on map.）

> 官方示例：[using-color-theme](https://docs.mapbox.com/android/maps/examples/android-view/using-color-theme/)

## 示例效果

![设置地图颜色主题](./images/using-color-theme.png)
...
This example demonstrates how to set a custom color theme in a map style using the setStyleColorTheme. You can provide a custom LUT (Look-Up Table) image to achieve this. To create a custom LUT, follow this guide.
...
- [官方文档（英文）](https://docs.mapbox.com/android/maps/examples/android-view/using-color-theme/)
- [GitHub 源码](https://github.com/mapbox/mapbox-maps-android/blob/v11.24.3/app/src/main/java/com/mapbox/maps/testapp/examples/style/ColorThemeActivity.kt)
